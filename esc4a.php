...
<body>
    <h1>DETALIS OF VARIOUS TYPE OF METERS INSTALLED IN AREA OF LICENSEE(URBAN AREA )</h1>
    <div class="header">
        <div class="left">
            <p>Discom: MPEZ</p>
            <p>Format: ESC-4A</p>
    ...
    <form id="dataForm" method="POST" action="esc4a_Submit.php">
        <table>
            <thead>
                <tr>
                    <th>S. NO.</th>
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type='text' name='entry[1][MeterType]'></td>
                    <td><input type='text' name='entry[1][MetersInstalledAtBeginning]'></td>
                    <td><input type='text' name='entry[1][MetersInstalledDuringPeriod]'></td>
                    <td><input type='text' name='entry[1][TotalMetersInstalledAtEnd]'></td>
                    <td><input type='text' name='entry[1][MetersAvailableInStock]'></td>
