...
// Prepare and bind
$stmt = $conn->prepare("INSERT INTO esc_10a (Sno, RegionName, ComplaintsPendingBeginning, ComplaintsReceivedDuringPeriod, TotalComplaintsReceived, ComplaintsResolvedSameDay, ComplaintsResolvedWithin5Days, ComplaintsPendingEnd, year) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
