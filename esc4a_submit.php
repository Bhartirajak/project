...
// Prepare and bind
$stmt = $conn->prepare("INSERT INTO esc_4a (Sno, MeterType, MetersInstalledAtBeginning, MetersInstalledDuringPeriod, TotalMetersInstalledAtEnd, MetersAvailableInStock, year) VALUES (?, ?, ?, ?, ?, ?, ?)");
