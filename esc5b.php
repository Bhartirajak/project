...
<body>
    <h1>PERIODIC TESTING OF METERS (RURAL AREA )</h1>
    <div class="header">
        <div class="left">
            <p>Discom: MPEZ</p>
            <p>Format: ESC-5B</p>
    ...
    <form id="dataForm" method="POST" action="esc5b_submit.php">
        <table>
            <thead>
                <tr>
                    <th>S. NO.</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class='text-left'><input type='text' name='entry[6][TotalMetersInstalledAtBeginning]'></td>
