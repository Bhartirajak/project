...
if ($conn->connect_error) {
 ...
 $stmt = $conn->prepare("INSERT INTO esc_6b (Sno, ConsumerCategory, ConsumersAppliedForTesting, AdditionalMeterInstalledWithin3Days, MetersTestedWithin15Days, CasesOfNonCompliance, ReasonsOfDelay, MetersWithinPermissibleLimits, MetersBeyondPermissibleLimits, ConsumerContestedResults, MetersTestedAtThirdPartyAgency, ContraryResultsToLicenseeTest, year) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
